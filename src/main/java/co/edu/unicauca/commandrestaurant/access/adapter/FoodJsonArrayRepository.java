...
public class FoodJsonArrayRepository implements IFoodJsonRepository{
    ...
    private void inicializar(){
        ...
        datos.add(new CryptFood(12, "Frijoles", FoodTypeEnum.PRINCIPIO));
        datos.add(new CryptFood(13, "Pollo Asado", FoodTypeEnum.CARNE));
        datos.add(new CryptFood(14, "Limonada", FoodTypeEnum.JUGO));
